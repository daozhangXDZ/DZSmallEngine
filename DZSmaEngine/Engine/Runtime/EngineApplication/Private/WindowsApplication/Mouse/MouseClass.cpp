#include "WindowsApplication/Mouse/MouseClass.h"
...
void MouseClass::OnMouseMove(int x, int y)
{
	...
	this->x = x;
	this->y = y;
	this->eventBuffer.push(MouseEvent(MouseEvent::EventType::Move, x, y,x-proX,y-proY));
}

void MouseClass::OnMouseMoveRaw(int x, int y)
{
	this->eventBuffer.push(MouseEvent(MouseEvent::EventType::RAW_MOVE, x, y, 0, 0));
}
...
MousePoint MouseClass::GetProPos()
{
	return { this->proX,this->proY };
}
